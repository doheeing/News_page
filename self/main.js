...
let url = new URL(
  `https://newsapi.org/v2/top-headlines?country=us&pageSize=${PAGE_SIZE}`
);
...
const getNewsByKeyword = () => {
  ...
  page = 1;
  url = new URL(
    `https://newsapi.org/v2/top-headlines?q=${keyword}&country=us&pageSize=${PAGE_SIZE}&apiKey=${API_KEY}`
  );
  getNews();
};
